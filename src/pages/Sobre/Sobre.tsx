    ...
    return (
        <>
            <Grid id='sobre' container>
                <Typography variant='h1' className='sobre-nos'>Sobre nós</Typography>
                <Grid className='texto-sobre' item container xs={12}>
                    <Typography variant='h6'>Somos uma e-commerce sustentável na qual usuários podem comprar e vender produtos novos,
