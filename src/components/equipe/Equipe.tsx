                    ...
                    <Grid item container className='contato-container'>
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <Box className='contato-cards'>
                                ...
                                <Typography textAlign='center' color='secondary' variant='h5' className='contato-nome'>Bruno<br />Kauã</Typography>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <Box className='contato-cards'>
                                ...
                                <Typography color='secondary' variant='h5' className='contato-nome'>Jeanine<br />Santiago</Typography>
                                <Box display='flex' style={{ gap: '15%' }}>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <Box className='contato-cards'>
                                ...
                                <Typography color='secondary' variant='h5' className='contato-nome'>Julia<br />Valerio</Typography>
                                <Box display='flex' style={{ gap: '15%' }}>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <Box className='contato-cards'>
                                ...
                                <Typography color='secondary' variant='h5' className='contato-nome'>Kaique<br />Ferreira</Typography>
                                <Box display='flex' style={{ gap: '15%' }}>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <Box className='contato-cards'>
                                ...
                                <Typography color='secondary' variant='h5' className='contato-nome'>Ketelyn<br />Medina</Typography>
                                <Box display='flex' style={{ gap: '15%' }}>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <Box className='contato-cards'>
                                ...
                                <Typography color='secondary' variant='h5' className='contato-nome'>Laís<br />Sales</Typography>
                                <Box display='flex' style={{ gap: '15%' }}>
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={3}>
                            <Box className='contato-cards'>
                                ...
                                <Typography color='secondary' variant='h5' className='contato-nome'>Letícia<br />Oliveira</Typography>
                                <Box display='flex' style={{ gap: '15%' }}>
